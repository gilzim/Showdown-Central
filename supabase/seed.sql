...
VALUES
  ('c1111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111111', 'Team Alpha'),
  ('c2222222-2222-2222-2222-222222222222', 'a1111111-1111-1111-1111-111111111111', 'Team Beta'),
  ('c3333333-3333-3333-3333-333333333333', 'a1111111-1111-1111-1111-111111111111', 'Team Gamma'),
  ('c4444444-4444-4444-4444-444444444444', 'a1111111-1111-1111-1111-111111111111', 'Team Delta');

-- 5. Link members to teams
INSERT INTO team_members (team_id, user_id)
VALUES
  ('c1111111-1111-1111-1111-111111111111', 'bfe0d864-9e63-4396-8862-66a0e216cdfa'),
  ('c2222222-2222-2222-2222-222222222222', 'bfe0d864-9e63-4396-8862-66a0e216cdfa'),
  ('c3333333-3333-3333-3333-333333333333', 'bfe0d864-9e63-4396-8862-66a0e216cdfa'),
  ('c4444444-4444-4444-4444-444444444444', 'bfe0d864-9e63-4396-8862-66a0e216cdfa');
